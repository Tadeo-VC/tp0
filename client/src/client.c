...
t_config* iniciar_config(void)
{
	...
	nuevo_config = config_create("/home/utnso/Desktop/SSOO/tp0/client/cliente.config");
...
void paquete(int conexion)
{
	...
	while (!strcmp(leido, "")) {  // aca podria hacer una abtraccion de leer consola agregando como parametro un puntero a una funcion? (log y crear paquete)
